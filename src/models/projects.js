...
const isUserVolunteering = async (projectId, userId) => {
  const query = `SELECT 1 FROM project_volunteer WHERE project_id = $1 AND user_id = $2`;
...
export {
  ...
  createProject,
  updateProject
  ,addVolunteer, removeVolunteer, getVolunteerProjectsByUserId, isUserVolunteering
};